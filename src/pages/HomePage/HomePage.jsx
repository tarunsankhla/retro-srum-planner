          ...
          <div className="homepage-cta-wrapper">
            <ul className="home-list">
              <li className="home-list-item">
                <i className="fas fa-check"></i>Increases your productivity
              </li>
              <li className="home-list-item">
                <i className="fas fa-check"></i>100% free plan for all users
              </li>
            </ul>
            <div className="homepage-cta">
              {userState.user.emailId ? (
                <Link
                  to="/dashboard"
                  className="homepage-btn btn primary-btn-md"
                >
                  Dashboard
                </Link>
              ) : (
